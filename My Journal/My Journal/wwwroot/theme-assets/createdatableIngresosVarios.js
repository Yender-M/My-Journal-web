...
function agregarRegistro() {
    ...
    var ministerioSelect = document.getElementById("ministerio");
    var ministerio = ministerioSelect.value;
    var ministerioText = ministerioSelect.options[ministerioSelect.selectedIndex].text;
    ...
    if (!categoria || !ministerio || !descripcion || !cantidad || !divisa || !tasaCambio || !fecha) {
    ...
    var form = $('form');
    form.append('<input type="hidden" name="IngresosCategorias" value="' + categoria + '">');
    form.append('<input type="hidden" name="Ministerios" value="' + ministerio + '">');
    ...
    form.append('<input type="hidden" name="FechaIngreso" value="' + fecha + '">');

    // Limpiar los campos de entrada
    document.getElementById("categoria").selectedIndex = 0;
    document.getElementById("ministerio").selectedIndex = 0;
